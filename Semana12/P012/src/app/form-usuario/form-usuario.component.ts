...
export class FormUsuarioComponent {
  ...
  constructor (private formChangesService : FormChangeServiceService) { }

  ngOnInit() {
    this.formChangesService.handleClick();
  }
  ...
  onSubmit() {
    ...
    this.formChangesService.handleSubmit();
    this.formChanges = this.formChangesService.getChanges();
  }
}
